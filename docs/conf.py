...
release = nanoutils.__version__  # The full version, including alpha/beta/rc tags.
...
htmlhelp_basename = 'nanoutils_doc'
...
# should be available in every file (another being rst_prolog).
rst_epilog = """
